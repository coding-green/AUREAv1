<footer class="footer-section spa-footer">
    <div class="container">
        <div class="row g-lg-12 gy-5 mb-70">
                ...
                <div class="footer-logo-section">
                    <div class="footer-top-section">
                        ...
                        <ul style="margin-left: 25px;">
                            ...
                            <li>
                                <a href="https://www.youtube.com/@AureBliss">
            ...
            <div
                class="col-lg-3 col-md-3 d-flex justify-content-xl-end justify-content-lg-center justify-content-md-end">
                <div class="footer-list">
                    <div class="footer-widget">
                        ...
                        <ul class="widget-list">
                            ...
                            <li>
                                <a href="why-we-are-different.php">
            ...
            <div
                ...
                <div class="footer-list">
                    <div class="footer-widget">
                        <div class="widget-title">
                            <h2 class="footer-block__heading inline-richtext" style="color: #fff; font-family: 'Roboto-regular', sans-serif;">Aurea Bliss</h2>
                        </div>
                        <ul class="widget-list">
                            <li>
                                <a style="cursor: pointer;">Email: info@aureabliss.com</a>
                            </li>
                            <li>
                                <a style="cursor: pointer;">Phone: +61-431045970</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="footer-btm-content">
                        <div class="copyright-area">
                            <p> © Copyright 2024 <a href="https://aureabliss.com/"> Aurea Bliss </a> | All Right
                                Reserved || Designed & Developed with &hearts; by <a href="https://360sourceinfotech.com">360SourceInfoTech.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
