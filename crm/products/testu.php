...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        ?>
        <form method="POST"> <!-- action to handle form submission -->
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="products_type"
                            value="<?php echo htmlspecialchars($product_type['product_type_name']); ?>" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="skin_type" rows="3"
                            ><?php echo trim($skin_types_text); ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="skin_concern" rows="3"
                            ><?php echo trim($skin_concern_text); ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="key_ingredients" rows="3"
                            ><?php echo htmlspecialchars($row['key_ingredients']); ?></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ideal_for"
                            value="<?php echo htmlspecialchars($row['ideal_for']); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="formulation"
                            value="<?php echo htmlspecialchars($formulation['formulation_name']); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="products_size"
                            value="<?php echo htmlspecialchars($row['size']); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="products_shelf_life"
                            value="<?php echo htmlspecialchars($row['shelf_life']); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="products_regimen_step"
                            value="<?php echo htmlspecialchars($row['regimen_recommendation']); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="products_state"
                            value="<?php echo htmlspecialchars($row['product_status']); ?>" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="products_pincode"
                            value="<?php echo htmlspecialchars($row['product_web_status']); ?>" >
                    </div>
                </div>
            </div>
        </form>
