        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="copyProductForm" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-3">
...
<script>
    $(document).ready(function () {
        ...
        $("#copyProductForm").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "products/copyproduct.php", // Point to the update script
                data: formData,
