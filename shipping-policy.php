...
<div style="max-width:900px;margin:auto;padding:50px 20px">
    ...
    <div class="section">
        ...
        <p>
            Shipping Charges vary according to locations and are applicable on all orders. We offer free shipping on orders above the value of INR 500.
        </p>
        <p>
    ...
    <div class="section">
        <h2>Tracking Packages</h2>
        <p>
            We will mail you the name of the courier company and the tracking number of your consignment in your registered email address. In case you do not receive a mail from us within 48hrs of placing an order please check your spam folder. Tracking may not appear online for up to another 24 hours in some cases, so please wait until your package is scanned by the courier company.
        </p>
    </div>

    <div class="section">
        <h2>Non-availability on Delivery</h2>
        <p>
