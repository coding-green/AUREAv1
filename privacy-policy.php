...
<main>
  ...
  <div>
    <meta charset="utf-8">
    <p>This Privacy Policy describes how <a href="https://aureabliss.com/">aureabliss.com</a> (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
    <h1>Contact</h1>
    <p>After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at <a href="abc@xyz.com">abc@xyz.com</a>.</p>
    ...
    <ul>
      ...
      <li>Order information
        <ul>
          ...
          <li><strong>Disclosure for a business purpose:</strong> shared with our processor Shopify and PayPal.</li>
          <li><strong>Personal Information collected:</strong> name, billing address, shipping address, payment information (including credit card numbers and PayPal account information), email address, and phone number.</li>
        </ul>
      </li>
      <li>Customer support information
        <ul>
          ...
          <li><strong>Source of collection:</strong> collected from you.</li>
          <li><strong>Disclosure for a business purpose:</strong> shared with our customer support platform Helpscout.</li>
          <li><strong>Personal Information collected:</strong> name, billing address, shipping address, payment information (including credit card numbers and PayPal account information), email address, and phone number.</li>
        </ul>
      </li>
    </ul>
    ...
    <p>We do engage in fully automated decision-making that has a legal or otherwise significant effect using customer data.</p>
    ...
    <table cellspacing="0" cellpadding="10">
      ...
      <tbody>
        ...
        <tr>
          <td>_shopify_sa_t</td>
          <td>Used in connection with marketing and referrals.</td>
          <td>30m</td>
        </tr>
      </tbody>
    </table>
